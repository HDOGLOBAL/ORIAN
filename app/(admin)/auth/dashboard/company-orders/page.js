        ...
        <div className="mb-6">
          <div className="flex flex-col md:flex-row gap-4 mb-4">
            <div className="relative flex-1">
              <input
                type="text"
                placeholder="Search by name, AWB or order nº..."
                value={searchQuery}
          ...
          <p className="text-sm text-gray-500">
            Company orders created manually. Separate from website orders.
          </p>
        </div>
          ...
          <table className="min-w-full text-sm text-left border border-gray-200">
            <thead className="bg-gray-100 text-gray-700">
              <tr>
                ...
                <th className="hidden lg:table-cell px-4 py-3 border">AWB</th>
                <th className="hidden lg:table-cell px-4 py-3 border">Items</th>
                <th className="px-4 py-3 border">Total Amount</th>
                <th className="px-4 py-3 border">Status</th>
                <th className="hidden lg:table-cell px-4 py-3 border">Order Date</th>
                <th className="hidden lg:table-cell px-4 py-3 border">Payment</th>
                <th className="hidden lg:table-cell px-4 py-3 border">Channel</th>
            ...
            <tbody>
              {orders.length === 0 ? (
                <tr>
                  ...
                  >
                    {searchQuery || statusFilter !== "all"
                      ? "No company orders found matching your criteria."
                ...
                orders.map((order) => (
                  ...
                  >
                    ...
                    <td className="hidden lg:table-cell px-4 py-2 border font-mono">
                      {order?.trackingId || "-"}
                    </td>
