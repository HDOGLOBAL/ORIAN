...
const TEXT = {
  en: {
    ...
    badge1: "Best Warranty and Quality",
    badge2: "We're here for your needs",
  },
  pt: {
    ...
    badge1: "Melhor Garantia e Qualidade",
    badge2: "Estamos aqui para si",
  },
  fr: {
    ...
    badge1: "Meilleure Garantie et Qualité",
    badge2: "Nous sommes là pour vous",
  },
  es: {
    ...
    badge1: "Mejor Garantía y Calidad",
    badge2: "Estamos aquí para ti",
  },
  he: {
    ...
    badge1: "אחריות ואיכות מיטבית",
    badge2: "אנחנו כאן לצרכיכם",
  },
  de: {
    ...
    badge1: "Beste Garantie und Qualität",
    badge2: "Wir sind für Sie da",
  },
};
      ...
      <div className="flex flex-col md:flex-row gap-8 items-stretch">
        ...
        <div className="relative w-full md:w-[42%] rounded-2xl overflow-hidden min-h-[340px]">
          ...
          <div className="absolute bottom-5 left-4 flex flex-col gap-2">
            <div className="flex items-center gap-2 bg-green-600 text-white text-sm font-semibold px-4 py-2 rounded-full shadow-md">
