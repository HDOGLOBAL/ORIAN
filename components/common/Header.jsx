...
export default function Header() {
  ...
  const textMap = {
    ...
    aboutUs: { pt: "Sobre Nós", fr: "À Propos", es: "Sobre Nosotros", en: "About Us", he: "אודותינו", de: "Über uns", it: "Chi Siamo" },
          ...
          <div className={`flex items-center justify-between h-16 py-2 ${isRtl ? "flex-row-reverse lg:flex-row-reverse" : "flex-row-reverse lg:flex-row"}`}>
            ...
            <Link href="/" className="hidden lg:flex items-center">
              <Image
                ...
                priority
                sizes="175px"
                className="relative z-10 flex items-center justify-center h-[140px] w-[175px] object-contain p-0 m-0"
              />
            </Link>
