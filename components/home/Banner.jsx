...
export default function Banner() {
  ...
  const textMap = {
    commercialFaucets: {
      ...
      de: {
        line1: "Alle Arten von",
        line2: "Gewerblichen Armaturen",
      },
    },
    sparePartsAccessories: {
      ...
      he: {
        line1: "כל חלקי החילוף והאביזרים",
        line2: "למיקסר דינמי",
      },
      de: {
        line1: "ALLE ERSATZTEILE &",
        line2: "ZUBEHÖR FÜR DYNAMISCHEN MIXER",
      },
    },
    shopNow: {
      pt: "Comprar Agora",
          ...
          <SwiperSlide key={idx}>
            <div className="relative w-full h-[280px] sm:h-[350px] md:h-[400px] lg:h-[429px] rounded-xl overflow-hidden shadow">
              ...
              <div className="absolute inset-0 z-20 hidden sm:block">
                <div
                  className={`absolute top-1/2 max-w-lg -translate-y-1/2 text-white ${isRtl ? "right-[12%] text-right" : "right-[18%] text-right"}`}
                >
                  <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
